...
function casagrande_enqueue_scripts()
{
    ...
    wp_enqueue_style('casagrande-css-style', get_template_directory_uri() . '/css/style.css', array(), '1.0', 'all');
    ...
    wp_enqueue_script('casagrande-bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array('jquery'), '1.0', true);
    wp_enqueue_script('casagrande-plugins', get_template_directory_uri() . '/js/plugins.js', array('jquery'), '1.0', true);
}

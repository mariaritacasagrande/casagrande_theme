...
<head>
    ...
    <meta name="description"
        content="Büro is a unique minimalist Premium HTML5 Template for creative agencies and freelances">
    <!-- Twitter Cards -->
    ...
    <title>Büro | Contact - HTML5 Premium Template for Studios &amp; Agencies</title>
        ...
        <main id="main">
                        ...
                        <form class="validate-form">
                            <div class="row">
                                ...
                                <div class="input-row col-md-6">
                                    ...
                                    <input type="email" class="form-control required-email" id="mail"
                            ...
                            <div class="row">
                                <div class="input-row col-md-6">
                                    ...
                                    <input type="tel" class="form-control required-number" id="phone"
            ...
            <div class="container newsletter mar-btm-lg">
                <div class="row">
                    <div class="col-md-6 col-md-offset-6">
                        <h5>Stay tunned</h5>
                        <p class="feat-text highlight">Subscribe to our newsletter in order to stay updated about our
                            new
                            projects.</p>
                        <form class="validate-news">
                            ...
                            <button type="submit" class="btn btn-submit">Subscribe<i
                                    class="arrow right-arrow"></i></button>
                        </form>
                        <small>* we promise that we won´t spam you, never.</small>
                        <small id="msg-submit-news" class="form-success hidde">You have been succesfully subscribed to
                            our
                            newsletter</small>
                    </div>
                </div>

    ...
    <main id="main">
        <?php if (have_posts()):
            while (have_posts()):
                ...
                <!-- Verifica a categoria 3 para adicionar classe diferente -->
                        ...
                        <?php if (have_comments()): ?>
                            ...
                            <div class="comments-wrapper">
                                ...
                                wp_list_comments(array(
                                    ...
                                    'short_ping' => true,
                                    'avatar_size' => 50,
                                    'callback' => 'custom_comments_callback', // Verifique se a função existe mesmo
                                ));
                                ?>
                            </div>
                        <?php else: ?>
                            <p>
                                <?php _e('No comments yet. Be the first to share your thoughts!', 'casagrande'); ?>
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
